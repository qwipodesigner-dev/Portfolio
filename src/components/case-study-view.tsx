...
/**
 * The full case-study body — cover, meta grid, hero art, sections,
 * reflection, live embed, walkthrough CTA. Shared between the public
 * /work/[slug] page and the admin draft-preview route so previews are
